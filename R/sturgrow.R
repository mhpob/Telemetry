...
sturgrow <- function(TEMP, SAL, DO, GR = 14, TL = NULL, CJ_OBS = 0, RATION = 1,
                   S4 = 29, S1 = 1, do1 = 25, ox = 13.55, rt1 = 6, rt4 = 28,
                   ct1 = 6, ct4 = 28, arm = 0.522, brm = -0.17, tk1rm = 0.141,
                   tk4rm = 0.796, crm = 1.0, drm = 1.048, grm = 0.748,
                   hrm = 0.268, irm = 0.352, smin = 9.166, b1 = -0.158,
                   afc = 1.028, bfc = -0.197, tk1fc = 0.195, tk4fc = 0.556,
                   tl98fc = 26.09, cfc = 1, dfc = 2.516, gfc = 0.733,
                   jfc = 0.359, kfc = 0.247, aeg = 0.335, ceg = -0.75,
